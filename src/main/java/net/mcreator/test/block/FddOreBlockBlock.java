...
public class FddOreBlockBlock extends TestElements.ModElement {
	@ObjectHolder("test:fddoreblock")
	public static final Block block = null;
	public FddOreBlockBlock(TestElements instance) {
		super(instance, 2);
	}
